...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rwa-python-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13517&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rwa-python-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rwa-python` can be installed with:

```
conda install rwa-python
```

It is possible to list all of the versions of `rwa-python` available on your platform with:
